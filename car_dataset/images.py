...
def draw_uncurated_result_figure(png, Gs, seed):
    ...
    for col in range(cols):
        for row in range(rows):
            ...
            images = Gs.get_output_for(latents, None, is_validation=True, randomize_noise=False, truncation_psi_val=0.7)
...
def main():
    ...
    # 888,1733
    draw_uncurated_result_figure('images/figure02-uncurated-ffhq2_truncation.png', Gs_baseline, seed=13)
    draw_uncurated_result_figure('images/figure02-uncurated-ffhq3_truncation.png', Gs_baseline, seed=15)
