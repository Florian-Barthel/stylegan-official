...
def draw_uncurated_result_figure(png, Gs, seed):
    ...
    images = Gs.get_output_for(latents, None, is_validation=True, randomize_noise=False)
...
def main():
    ...
    # 888,1733
    draw_uncurated_result_figure('images/figure02-uncurated-ffhq.png', Gs_baseline, seed=13)
    draw_uncurated_result_figure('images/figure02-uncurated-ffhq2.png', Gs_baseline, seed=15)
