...
simple_plot(x, y, 'Million Images Seen by the Discriminator', 'Fréchet Inception Distance', 'Fréchet Inception Distance over the Training', 'fid_baseline', 6, 16, 6, 10, 3, 1)
