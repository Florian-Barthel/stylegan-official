...
def main():
    ...
    draw_noise_detail_figure('noise_detail.png', Gs_baseline, w=256, h=256, num_samples=100, seeds=[5, 4])
    draw_noise_components_figure('noise-components.png', Gs_baseline, w=256, h=256, seeds=[5, 4], noise_ranges=[range(0, 14), range(0, 0)], flips=[])
