...
x_base, y_base = get_data('fid50k', 15)
x_compare, y_compare = get_data('fid50k', 29)
compare_plot(x_base, y_base, x_compare, y_compare, 'Million Images Seen by the Discriminator',
             'Fréchet Inception Distance', 'Fréchet Inception Distance over the Training', 'fid_remove_mapping', 6, 15.5, 5, 14, 3, 1, 'Model Without Mapping Network')
