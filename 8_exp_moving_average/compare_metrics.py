...
x_base, y_base = get_data('fid50k', 15)
x_compare, y_compare = get_data('fid50k_no_exp_mov_avg', 15)
compare_plot(x_base, y_base, x_compare, y_compare, 'Million Images Seen by the Discriminator', 'Fréchet Inception Distance',
             'Fréchet Inception Distance over the Training', 'fid_validation', 6, 15.5, 0, 25, 3, 5, 'Baseline Model without Exp. Moving Avg.')
