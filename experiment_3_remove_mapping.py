...
if 1:
    ...
    G             = EasyDict(func_name='training.networks_stylegan_0_mapping_layers.G_style')               # Options for generator network.
    D             = EasyDict(func_name='training.networks_stylegan_0_mapping_layers.D_basic')               # Options for discriminator network.
